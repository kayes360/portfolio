const projects=[
  {
    web_app: [
      ...
      {
        id: 3,
        projectName: "kanban-project-manager",
        description: "",
        technologyUsed: [],
        liveUrl: "",
      ...
      {
        id: 4,
        projectName: "URL Manager Browser Extension",
        description:
      ...
      {
        id: 7,
        projectName: "Doctors Appointment Booking Application",
  ...
  },
  {
    web_ui: [
      ...
      {
        id: 9,
        projectName: "React Bootstrap Landing Page",
      ...
      {
        id: 10,
        projectName: "Collition Box",
        description:
          "This project is a React, Vite, and TypeScript-based animated container with moving boxes, rendered using a Canvas element. The animation creates an engaging visual experience",
        technologyUsed: [
          "React",
          "Vite",
          "TypeScript",
